...
public class Exercise_2 {
 //Secuenciales
    /*2. Realizar en Java un programa que calcule el área de un triángulo y visualice el resultado según se 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El área de un triángulo de base "+base_triangulo+" cm. y altura 3.5"+altura_triangulo+" cm. es "+area_triangulo+" cm. cuadrados");
    }
}